...
Lie groups are continuous symmetry groups that appear throughout physics—rotations, Lorentz transformations, gauge symmetries. Their infinitesimal structure, encoded in Lie algebras, connects to [Hamiltonian mechanics](../classical-mechanics/hamiltonian-mechanics.md) via Poisson brackets and to [quantum mechanics](../quantum-mechanics/quantum-mechanics.md) via commutators. This document requires [linear algebra](../prerequisites/linear-algebra.md) (matrices, exponentials, eigenvalues) and [calculus](../prerequisites/calculus-primer.md) (Taylor series). The Lorentz group underlies [special relativity](../relativity/special-relativity.md); SU(2) describes [spin angular momentum](../quantum-mechanics/spin-angular-momentum.md); spinor representations appear in the [Dirac equation](../quantum-mechanics/dirac-equation.md).
...
**What this means:** $SO(3)$ is the group of all rotations in 3D space—fundamental to classical mechanics and [angular momentum in quantum mechanics](../quantum-mechanics/quantum-mechanics.md).
...
**What this means:** These are the same properties as [Poisson brackets](../classical-mechanics/hamiltonian-mechanics.md)! This is no coincidence—Poisson brackets make functions on phase space into a Lie algebra.
...
**What this means:** This is the angular momentum algebra! In [quantum mechanics](../quantum-mechanics/quantum-mechanics.md), $[\hat{L}_i, \hat{L}_j] = i\hbar \epsilon_{ijk} \hat{L}_k$ is the same structure (with an $i\hbar$).
...
By [Noether's theorem](../classical-mechanics/lagrangian-mechanics.md), every continuous symmetry gives a conserved quantity:
