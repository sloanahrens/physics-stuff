...
In [natural units](natural-units.md) with $G = c = \hbar = k_B = 1$:
...
The thermal interpretation of quantum field theory (see [path integrals](path-integrals.md)) gives:
