...
In [quantum mechanics](quantum-mechanics.md), the **uncertainty principle** bounds products of standard deviations:
...
See [statistical mechanics](statistical-mechanics.md).
...
This is the foundation of [statistical mechanics](statistical-mechanics.md).
...
See [quantum mechanics](quantum-mechanics.md) for details.
...
**What this means:** Entropy measures the "amount of randomness" or "missing information" in a probability distribution. See [statistical mechanics](statistical-mechanics.md).
...
Entangled quantum states can exhibit correlations that exceed classical limits (Bell inequalities). This is a deep feature of [quantum mechanics](quantum-mechanics.md).
