...
Differential forms provide an elegant, coordinate-independent language for calculus on manifolds. They unify gradient, curl, and divergence into a single operation, and express physical laws like [Maxwell's equations](maxwell-covariant.md) in their most natural form. This document builds on [tensor calculus](tensor-calculus.md) and connects to the geometric structure of [Lie groups](lie-groups.md).
